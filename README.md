...
&emsp;  Программа пока не обрабатывает разбитые на части пакеты, соответственно, не находит в логе ничего, либо выдает ошибку. Столкнулся один раз с этим на s21. Возможно это просто сбой, т.к wireshark некорректно восстановил сбойный пакет. В этом случае нужно повторить всю процедуру еще раз.<br> 
</details>
