...
* 2022.06.07. Добавлен датчик дыма RSS-61S. Окно определения количества воды при нагреве 65-85&deg;C. Добавлена конфигурация для сборки с среде Platformio, спасибо [bvp](https://github.com/bvp) подробнее [здесь](https://github.com/alutov/ESP32-R4sGate-for-Redmond/pull/89).
