...
Image 7. Main screen example 2.<br><br>
 Если экран не нужен, то нужно лишь после программирования esp32 и настройки подсоединить ее к источнику питания и спрятать где-нибудь на кухне.
# Rebuild notes
