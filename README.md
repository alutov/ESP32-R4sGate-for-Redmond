...
&emsp;  Программа пока не обрабатывает в логе разбитые на части пакеты, соответственно, не находит в логе ничего, либо выдает ошибку. Столкнулся с этим на s21. В этом случае нужно повторить всю процедуру еще раз.<br> 
</details>
