...
Достаем из архива файлы btsnoop_hci.log и.или btsnoop_hci.log.last из папки "FS/data/log/bt/". В одном из этих файлов должнет быть лог привязки. Далее в папку с этими файлами сохраняем [архив с консольной утилитой stsk.exe](https://github.com/alutov/ESP32-R4sGate-for-Redmond/raw/master/utils/stsk.zip) и достаем программу из архива.  Открываем командную сnроку windows, заходим в папку с файлами и набираем "stsk btsnoop_hci.log" или "stsk btsnoop_hci.log.last" Программа выведет найденные Smart Tag и сгенерит ключи для них. Последний ключ будет скопирован в буфер обмена windows.<br>     
</details>
