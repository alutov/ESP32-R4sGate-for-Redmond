...
> **Шлюз использует Mqtt, что позволяет ему работать с практически всеми системами умного дома. Отображаемая на экране дополнительная информация также берется с Mqtt. Любителей ESPHome прошу не спамить в issues, а искать другие решения. Портирование в ESPHome, а также призязка шлюза к работе исключительно с Home Assistant не планируются.**<br> 
