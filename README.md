...
&emsp;Поддерживаются 5 одновременных BLE соединений. Управление устройствами возможно и из web интерфейса шлюза. Предусмотрена [простая защита web интерфейса паролем от Raerten](https://github.com/alutov/ESP32-R4sGate-for-Redmond/pull/67). Для этого строку виде login:password нужно зашифровать в Base 64 и затем вписать ее в поле ***Basic Auth*** в настройках. Строка пароля выводится в лог при старте шлюза.<br>
