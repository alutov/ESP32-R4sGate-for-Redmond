...
> **В версиях, начиная где-то с июня 2022, несколько раз менялся формат записи данных в NVS. Иногда это может привести к искажению данных в настройках после обновления. Возможны проблемы с wifi и ble, так как их настройки также хранятся в NVS. После обновления на последние версии следует зайти в настройки, проверить данные , затем отметить пункт "Format NVS area" и далее "Save setting". Память NVS  будет отформатирована и затем все данные заново перезаписаны.<br>**
...
* 2022.09.14. Добавлена в Xiaomi Mi Scale сенсор предварительного (provisional) значения веса.
