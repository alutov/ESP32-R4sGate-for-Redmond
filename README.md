...
#### Текущая версия 2023.08.22 для [ESP32](https://github.com/alutov/ESP32-R4sGate-for-Redmond/raw/master/build/r4sGate.bin) и [ESP32C3](https://github.com/alutov/ESP32-R4sGate-for-Redmond/raw/master/C3/build/r4sGate.bin).
* 2023.08.22. Добавлена поддержка экранов на ST7789. Нужно еще тестировать. Перераспределение памяти. Мелкие исправления.
