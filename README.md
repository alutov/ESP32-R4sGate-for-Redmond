...
> **Поправил 6 апреля последнюю версию. Добавил индикацию типа скана, заменил стоп старт mqtt при падении Wifш на reconnect. Возможно также, была ошибка при запуске сканирования с отвалом BLE.**
