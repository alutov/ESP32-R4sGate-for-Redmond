...
* 2022.05.20. Защищенное шифрованное ble соединение для устройств, кроме климатической станции, запрашивается после 3-х неуспешных попыток авторизации при незащищенном соединении. В Mqtt Discovery в свойства устройств добавлен MAC адрес. При неизвестном количестве аоды в Mqtt вместо "?" выводится "-0.0". 
