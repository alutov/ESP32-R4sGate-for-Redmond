...
* 2022.05.06. При изменении значений "Timeout" в BLE мониторе нажатие "Ok" сразу записывает все значения в энергонезависимую память и новые устройства Mqtt Discovery сразу отправляет в Home Assistant. Мелкие исправления.
