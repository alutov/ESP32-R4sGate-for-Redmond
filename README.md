...
* 2022.09.13. Добавлен выбор NTP сервера в настройках. После кипячения, если он был включен шлюзом, возвращается режим ночника, если перед этим он был включен.
