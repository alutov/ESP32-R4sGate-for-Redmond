...
> **Поправил 6 апреля последнюю версию. Добавил индикацию типа скана, заменил стоп старт mqtt при падении Wif на reconnect. Возможно, была ошибка при запуске сканирования с отвалом BLE.**
