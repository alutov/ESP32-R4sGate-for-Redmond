...
> **Прошивка использует Mqtt, что позволяет использовать ее с практически всеми системами УД. Отображаемая на экране дополнительная информация также берется с Mqtt. Любителей ESPHome прошу не спамить в issues, а искать другие решения - портирование в ESPHome не планируется.**<br> 
