...
* Redmond SkyHeat 4529S (SkyPort 103S)

&emsp; Поддерживается Home Assistant Mqtt Discovery. Предусмотрено 5 портов ввода-вывода. Есть также поддержка TFT экрана 320 * 240 на чипах ili9341 и ili9342.
