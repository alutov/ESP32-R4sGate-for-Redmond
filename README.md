...
#### [Текущая версия 2023.02.23](https://github.com/alutov/ESP32-R4sGate-for-Redmond/raw/master/build/r4sGate.bin).
* 2023.02.23. Добавлена поддержка сенсора SHT4x(0x44, 0x45), SCD4x(0x62). Мелкие исправления.
