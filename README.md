...
&emsp;Предусмотрено 5 портов ввода-вывода для управления внешними устройствами и чтения их состояния. Четыре порта можно настроить как кнопки для включения - выключения подключенных BLE устройств, пятый порт - как кнопку обновления картинки с камеры. При конфигурации в режиме входа включается pullup, если это возможно (номер пина меньше 34).<br>
