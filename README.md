...
* Вывод количества воды в чайнике на экран, сенсор количества воды после последнего кипячения. Добавлен BLE monitor. 
...
&emsp; Шлюз также можно использовать для отслеживания до 8 ble устройств (меток) по MAC адресу. Выводится наличие/отсутствие метки и rssi. 
