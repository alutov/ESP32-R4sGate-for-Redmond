...
#### Screen support<br>
 ...
 If the screen is not needed, then you just need to connect it to the power source after programming esp32 and setting it up and hide it somewhere in the kitchen.<br><br>
