...
* В MQTT могут обмениваться информацией устройства, вообще не знающих друг о друге ничего, кроме топика, где они должны встретиться. Это используется для определения максимального уровня сигнала от метки/маяка и шлюза, принимающего самый сильный сигнал. 
</details>     
