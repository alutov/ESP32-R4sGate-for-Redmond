...
&emsp; Поддерживается Home Assistant Mqtt Discovery. Предусмотрено 5 портов ввода-вывода для управления внешними устройствами и чтения их состояния. Три первых порта можно настроить для включения - выключения подключенных по BLE устройств. Возможно подключение TFT экрана 320 * 240 на чипах ili9341 и ili9342.
