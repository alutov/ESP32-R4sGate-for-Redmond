...
&emsp;  Программа пока не обрабатывает разбитые на части пакеты, соответственно, не находит в логе ничего, либо выдает ошибку. Столкнулся один раз с этим на s21. В этом случае нужно повторить всю процедуру еще раз.<br> 
</details>
