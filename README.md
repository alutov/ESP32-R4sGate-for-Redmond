...
> **Тереграм каналы, в частности https://t.me/ESP32_R4sGate, никакого отношения к проекту не имеют, информацией помимо этой страницы не обладают, равно как и разрешением автора проекта.<br>**
