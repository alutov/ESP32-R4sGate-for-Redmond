...
#### Текущая версия 2022.04.23.
* Добавлена [авторизация из Raerten pull request #67](https://github.com/alutov/ESP32-R4sGate-for-Redmond/pull/67). Добавлена регулировка яркости экрана в топике screen. допустимые значения от 0 до 255. Добавлена возможность вызова картинки пятой кнопкой, пункт jpg. При конфигурации входов в режиме кнопок включается pullup, если пин меньше 34.
