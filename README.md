...
## 4. BLE Monitor
&emsp;Монитор позволяет отслеживать метки(маяки) со статическими MAC адресами. Выводится наличие/отсутствие метки(маяка) и rssi. **Дополнительно поддерживаются:**
