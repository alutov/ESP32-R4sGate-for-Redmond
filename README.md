...
&emsp;  Программа пока не обрабатывает разбитые на части пакеты, соответственно, если встречает такой пакет, то не находит в логе ничего или выдает ошибку. Столкнулся один раз с этим на s21. Возможно это просто сбой, т.к wireshark тоже не совс-ем корректно восстановил сбойный пакет. В этом случае нужно повторить всю процедуру еще раз.<br> 
</details>
