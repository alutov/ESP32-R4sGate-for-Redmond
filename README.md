...
> **Поправил 6 апреля последнюю версию. Добавил индикацию типа скана, заменил стоп старт mqtt при падении Wifi на reconnect. Возможно также, была ошибка при запуске сканирования с отвалом BLE.**

#### Текущая версия 2022.04.11.
