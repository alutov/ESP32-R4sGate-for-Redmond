...
//
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/hstate\",\"mode_command_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/cmd/state\"");
...
//	strcat(bufd,"1.Cooker.switch\",\"icon\":\"mdi:pot-steam\",\"uniq_id\":\"switch_");
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/cmd/state\",\"pl_on\":\"heat\",\"pl_off\":\"off\",\"state_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
