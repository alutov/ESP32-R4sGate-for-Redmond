...
****************************************************************
	...
	Lutov Andrey  Donetsk 2020.07.09
Use for compilation ESP-IDF Programming Guide:
https://docs.espressif.com/projects/esp-idf/en/latest/esp32/
****************************************************************
*/

// It's a good idea to connect tft in the future
//#define USE_TFT
...
static esp_err_t pmain_get_handler(httpd_req_t *req)
{
	...
	strcat(bsend,buff);
        ...
        strcat(bsend,"<tr><td style='min-width:150px;'>Version</td><td style='width:80%;'>2020.07.09</td></tr>");
...
//r4s state nonitoring and command execution loop
	...
	if (t_before_us - t_clock_us > 1000000) {
#ifdef USE_TFT
	tftclock();
#endif
