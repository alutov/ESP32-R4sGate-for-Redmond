...
static esp_err_t psetting_get_handler(httpd_req_t *req)
{
	...
	strcat(bsend,"\" size=\"15\"> WIFI SSID</br><input type=\"password\" input name=\"swfpsw\" value=\"");
	...
	strcat(bsend,"\"size=\"15\"> MQTT Login</br><input type=\"password\" input name=\"smqpsw\" value=\"");
