...
//ESP_LOGI(AP_TAG,"topoffa=%d", topoffa);
	...
	if ((!bStateA) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {
	r4slppar1a = 0;
	r4slpcoma = 2;
	}
//	ESP_LOGI(AP_TAG,"MQTT_CMD_ON");
	...
	if ((bStateA)  || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {
	r4slppar1a = 0;
	r4slpcoma = 1;
	}	
...
//	bprevStateA = 255;
	...
	mystrcpy(tbuff, event->data, tempsz);
	uint8_t temp = atoi(tbuff);
	if  ((temp > 39) && (temp < 91) && (temp != bHtempA)) {
	r4slppar1a = temp;
	r4slpcoma = 3;
	} else if (temp > 90) {
	r4slppar1a = 0;
...
//	ESP_LOGI(AP_TAG,"MQTT_HEAT_TEMP");
	...
	if ((!bStNlA) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {
	r4slppar1a = 0;
	r4slpcoma = 5;
	}
//	ESP_LOGI(AP_TAG,"MQTT_NIGHTLIGHT_ON");
		...
		|| (!incascmp("false",event->data,event->data_len))) {
	if ((bStNlA) || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {
	r4slppar1a = 0;
	r4slpcoma = 1;
	}
...
//	ESP_LOGI(AP_TAG,"MQTT_CMD_OFF");
	...
	if ((!incascmp("1",event->data,event->data_len)) || (!incascmp("on",event->data,event->data_len))
		|| (!incascmp("true",event->data,event->data_len))) {
	if ((!bModProgA) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {	
	r4slppar1a = 0;
	r4slpcoma = 8;
	}
//	ESP_LOGI(AP_TAG,"MQTT_lock_ON");
		...
		|| (!incascmp("false",event->data,event->data_len))) {
	if ((bModProgA) || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {	
	r4slppar1a = 0;
	r4slpcoma = 7;
	}	
...
//	ESP_LOGI(AP_TAG,"MQTT_lock_OFF");
	...
	if ((!incascmp("1",event->data,event->data_len)) || (!incascmp("on",event->data,event->data_len))
		|| (!incascmp("true",event->data,event->data_len))) {
	if ((!bProgA) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {	
	r4slppar1a = 1;
	r4slpcoma = 9;
	}
//	ESP_LOGI(AP_TAG,"MQTT_strength_ON");
		...
		|| (!incascmp("false",event->data,event->data_len))) {
	if ((bProgA) || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {	
	r4slppar1a = 0;
	r4slpcoma = 9;
	}	
...
//	ESP_LOGI(AP_TAG,"MQTT_CMD_OFF");
	...
	if ((!incascmp("1",event->data,event->data_len)) || (!incascmp("on",event->data,event->data_len))
		|| (!incascmp("true",event->data,event->data_len))) {
	if ((!bAwarmA) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {	
	r4slppar1a = 1;
	r4slpcoma = 16;
	}
	} else if ((!incascmp("0",event->data,event->data_len)) || (!incascmp("off",event->data,event->data_len))
		|| (!incascmp("false",event->data,event->data_len))) {
	if ((bAwarmA) || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {	
	r4slppar1a = 0;
	r4slpcoma = 16;
	}
	}
...
//ESP_LOGI(AP_TAG,"topoffb=%d", topoffb);
	...
	if ((!incascmp("1",event->data,event->data_len)) || (!incascmp("on",event->data,event->data_len))
		|| (!incascmp("true",event->data,event->data_len)) || (!incascmp("heat",event->data,event->data_len))) {
	if ((!bStateB) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {
	r4slppar1b = 0;
	r4slpcomb = 2;
	}
//	ESP_LOGI(AP_TAG,"MQTT_CMD_ON");
		...
		|| (!incascmp("false",event->data,event->data_len))) {
	if ((bStateB) || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {
	r4slppar1b = 0;
	r4slpcomb = 1;
	}	
//	ESP_LOGI(AP_TAG,"MQTT_CMD_OFF");
...
//	bprevStateB = 255;
	...
	mystrcpy(tbuff, event->data, tempsz);
	uint8_t temp = atoi(tbuff);
	if  ((temp > 39) && (temp < 91) && (temp != bHtempB)) {
	r4slppar1b = temp;
	r4slpcomb = 3;
	} else if (temp > 90) {
	r4slppar1b = 0;
...
//	ESP_LOGI(AP_TAG,"MQTT_HEAT_TEMP");
	...
	if ((!incascmp("1",event->data,event->data_len)) || (!incascmp("on",event->data,event->data_len))
		|| (!incascmp("true",event->data,event->data_len))) {
	if ((!bStNlB) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {
	r4slppar1b = 0;
	r4slpcomb = 5;
	}
//	ESP_LOGI(AP_TAG,"MQTT_NIGHTLIGHT_ON");
		...
		|| (!incascmp("false",event->data,event->data_len))) {
	if ((bStNlB) || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {
	r4slppar1b = 0;
	r4slpcomb = 1;
	}
//	ESP_LOGI(AP_TAG,"MQTT_NIGHTLIGHT_OFF");
...
//	ESP_LOGI(AP_TAG,"MQTT_CMD_OFF");
	...
	if ((!incascmp("1",event->data,event->data_len)) || (!incascmp("on",event->data,event->data_len))
		|| (!incascmp("true",event->data,event->data_len))) {
	if ((!bModProgB) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {	
	r4slppar1b = 0;
	r4slpcomb = 8;
	}
//	ESP_LOGI(AP_TAG,"MQTT_lock_ON");
		...
		|| (!incascmp("false",event->data,event->data_len))) {
	if ((bModProgB) || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {	
	r4slppar1b = 0;
	r4slpcomb = 7;
	}	
//	ESP_LOGI(AP_TAG,"MQTT_lock_OFF");
...
//	ESP_LOGI(AP_TAG,"MQTT_lock_OFF");
	...
	if ((!incascmp("1",event->data,event->data_len)) || (!incascmp("on",event->data,event->data_len))
		|| (!incascmp("true",event->data,event->data_len))) {
	if ((!bProgB) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {	
	r4slppar1b = 1;
	r4slpcomb = 9;
	}
//	ESP_LOGI(AP_TAG,"MQTT_strength_ON");
		...
		|| (!incascmp("false",event->data,event->data_len))) {
	if ((bProgB) || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {	
	r4slppar1b = 0;
	r4slpcomb = 9;
	}	
//	ESP_LOGI(AP_TAG,"MQTT_strength_OFF");
...
//	ESP_LOGI(AP_TAG,"MQTT_CMD_OFF");
	...
	if ((!incascmp("1",event->data,event->data_len)) || (!incascmp("on",event->data,event->data_len))
		|| (!incascmp("true",event->data,event->data_len))) {
	if ((!bAwarmB) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {	
	r4slppar1b = 1;
	r4slpcomb = 16;
	}
	} else if ((!incascmp("0",event->data,event->data_len)) || (!incascmp("off",event->data,event->data_len))
		|| (!incascmp("false",event->data,event->data_len))) {
	if ((bAwarmB) || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {	
	r4slppar1b = 0;
	r4slpcomb = 16;
	}
	}
...
//ESP_LOGI(AP_TAG,"topoffc=%d", topoffc);
	...
	if ((!incascmp("1",event->data,event->data_len)) || (!incascmp("on",event->data,event->data_len))
		|| (!incascmp("true",event->data,event->data_len)) || (!incascmp("heat",event->data,event->data_len))) {
	if ((!bStateC) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {
	r4slppar1c = 0;
	r4slpcomc = 2;
	}
//	ESP_LOGI(AP_TAG,"MQTT_CMD_ON");
		...
		|| (!incascmp("false",event->data,event->data_len))) {
	if ((bStateC) || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {
	r4slppar1c = 0;
	r4slpcomc = 1;
	}	
//	ESP_LOGI(AP_TAG,"MQTT_CMD_OFF");
...
//	bprevStateC = 255;
	...
	mystrcpy(tbuff, event->data, tempsz);
	uint8_t temp = atoi(tbuff);
	if  ((temp > 39) && (temp < 91) && (temp != bHtempC)) {
	r4slppar1c = temp;
	r4slpcomc = 3;
	} else if (temp > 90) {
	r4slppar1c = 0;
...
//	ESP_LOGI(AP_TAG,"MQTT_HEAT_TEMP");
	...
	if ((!incascmp("1",event->data,event->data_len)) || (!incascmp("on",event->data,event->data_len))
		|| (!incascmp("true",event->data,event->data_len))) {
	if ((!bStNlC) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {
	r4slppar1c = 0;
	r4slpcomc = 5;
	}
//	ESP_LOGI(AP_TAG,"MQTT_NIGHTLIGHT_ON");
		...
		|| (!incascmp("false",event->data,event->data_len))) {
	if ((bStNlC) || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {
	r4slppar1c = 0;
	r4slpcomc = 1;
	}
//	ESP_LOGI(AP_TAG,"MQTT_NIGHTLIGHT_OFF");
...
//	ESP_LOGI(AP_TAG,"MQTT_CMD_OFF");
	...
	if ((!incascmp("1",event->data,event->data_len)) || (!incascmp("on",event->data,event->data_len))
		|| (!incascmp("true",event->data,event->data_len))) {
	if ((!bModProgC) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {	
	r4slppar1c = 0;
	r4slpcomc = 8;
	}
//	ESP_LOGI(AP_TAG,"MQTT_lock_ON");
		...
		|| (!incascmp("false",event->data,event->data_len))) {
	if ((bModProgC) || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {	
	r4slppar1c = 0;
	r4slpcomc = 7;
	}	
//	ESP_LOGI(AP_TAG,"MQTT_lock_OFF");
...
//	ESP_LOGI(AP_TAG,"MQTT_lock_OFF");
	...
	if ((!incascmp("1",event->data,event->data_len)) || (!incascmp("on",event->data,event->data_len))
		|| (!incascmp("true",event->data,event->data_len))) {
	if ((!bProgC) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {	
	r4slppar1c = 1;
	r4slpcomc = 9;
	}
//	ESP_LOGI(AP_TAG,"MQTT_strength_ON");
		...
		|| (!incascmp("false",event->data,event->data_len))) {
	if ((bProgC) || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {	
	r4slppar1c = 0;
	r4slpcomc = 9;
	}	
//	ESP_LOGI(AP_TAG,"MQTT_strength_OFF");
...
//	ESP_LOGI(AP_TAG,"MQTT_CMD_OFF");
	...
	if ((!incascmp("1",event->data,event->data_len)) || (!incascmp("on",event->data,event->data_len))
		|| (!incascmp("true",event->data,event->data_len))) {
	if ((!bAwarmC) || (!fcommtp) || (inccmp(strON,event->data,event->data_len))) {	
	r4slppar1c = 1;
	r4slpcomc = 16;
	}
	} else if ((!incascmp("0",event->data,event->data_len)) || (!incascmp("off",event->data,event->data_len))
		|| (!incascmp("false",event->data,event->data_len))) {
	if ((bAwarmC) || (!fcommtp) || (inccmp(strOFF,event->data,event->data_len))) {	
	r4slppar1c = 0;
	r4slpcomc = 16;
	}
	}
