...
void MqttPubSubA () {
	...
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/heat_temp");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	strcpy(buft,MQTT_BASE_TOPIC);
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/nightlight");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	strcpy(buft,MQTT_BASE_TOPIC);
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/nightlight_red");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	strcpy(buft,MQTT_BASE_TOPIC);
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/nightlight_green");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	strcpy(buft,MQTT_BASE_TOPIC);
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/nightlight_blue");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	strcpy(buft,MQTT_BASE_TOPIC);
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/nightlight_rgb");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/cmd/state\",\"state_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/state\",\"availability_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/status\"}");
...
//
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/cmd/heat_temp\",\"temperature_state_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/heat_temp\",\"current_temperature_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/temp\",\"min_temp\":\"0\",\"max_temp\":\"100\",\"availability_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/hastate\"");
	strcat(bufd,",\"temp_step\":\"1\",\"modes\":[\"off\"]}");
	esp_mqtt_client_publish(mqttclient, buft, bufd, 0, 1, 1);
//
...
//
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/cmd/nightlight\",\"state_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/nightlight\",\"rgb_cmd_t\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/cmd/nightlight_rgb\",\"rgb_stat_t\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/nightlight_rgb\",\"availability_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/status\"}");
...
//
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/cmd/lock\",\"state_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/lock\",\"availability_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/status\"}");
...
//
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/cmd/strength\",\"state_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/strength\",\"availability_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/status\"}");
...
//
	...
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/prname");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	strcpy(buft,MQTT_BASE_TOPIC);
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/prog");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	strcpy(buft,MQTT_BASE_TOPIC);
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/mode");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	strcpy(buft,MQTT_BASE_TOPIC);
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/temp");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	strcpy(buft,MQTT_BASE_TOPIC);
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/set_hour");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	strcpy(buft,MQTT_BASE_TOPIC);
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/set_min");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	strcpy(buft,MQTT_BASE_TOPIC);
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/delay_hour");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	strcpy(buft,MQTT_BASE_TOPIC);
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/delay_min");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	strcpy(buft,MQTT_BASE_TOPIC);
	strcat(buft,"/");
	strcat(buft,tBLEAddrA);
	strcat(buft,"/cmd/warm");
	esp_mqtt_client_subscribe(mqttclient, buft, 0);
	if (FDHass) {
	strcpy(buft,"homeassistant/switch/");
	strcat(buft,MQTT_BASE_TOPIC);
...
//	strcat(bufd,"1.Cooker.switch\",\"icon\":\"mdi:pot-steam\",\"uniq_id\":\"switch_");
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/hstate\",\"availability_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/status\"}");
...
//	strcat(bufd,"1.Cooker.warming\",\"icon\":\"mdi:chef-hat\",\"uniq_id\":\"warm_");
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/cmd/warm\",\"state_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/warm\",\"availability_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/status\"}");
...
//
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/cmd/temp\",\"temperature_state_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/temp\",\"current_temperature_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/temp\",\"min_temp\":\"0\",\"max_temp\":\"100\",\"availability_topic\":\"");
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/prname\"");
	strcat(bufd,",\"hold_command_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/cmd/prname\"");

	strcat(bufd,",\"temp_lo_stat_t\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/set_hour\"");
	strcat(bufd,",\"temp_hi_stat_t\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/set_min\"");
	strcat(bufd,",\"temp_lo_cmd_t\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/cmd/set_hour\"");
	strcat(bufd,",\"temp_hi_cmd_t\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/cmd/set_min\"");

	strcat(bufd,",\"temp_step\":\"1\",\"modes\":[\"auto\"],\"hold_modes\":[\"OFF\",\"Rice\",\"Slow_cooking\",\"Pilaf\",\"Frying_vegetables\"");
...
//
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/prname\",\"availability_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/status\"}");
...
//
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/hour\",\"availability_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/status\"}");
...
//
	...
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/rsp/min\",\"availability_topic\":\"");
	strcat(bufd,MQTT_BASE_TOPIC);
	strcat(bufd,"/");
	strcat(bufd,tBLEAddrA);
	strcat(bufd,"/status\"}");
...
void mAsStatus() {
	...
	bStateA = notifyDataA[11];
        ...
        bAwarmA = notifyDataA[14];                   //strength of coffee
	bCHourA = notifyDataA[8];                      //curr time
	bCMinA = notifyDataA[9];
	strcpy(cStatusA,"{\"state\":");
	itoa(notifyDataA[11],tmpvar,10);
	strcat(cStatusA,tmpvar);
	strcpy(cStatusA,"{\"strength\":");
...
void mBsStatus() {
	...
	bStateB = notifyDataB[11];
        ...
        bAwarmB = notifyDataB[14];                   //strength of coffee
	bCHourB = notifyDataB[8];                      //curr time
	bCMinB = notifyDataB[9];
	strcpy(cStatusB,"{\"state\":");
	itoa(notifyDataB[11],tmpvar,10);
	strcat(cStatusB,tmpvar);
	strcpy(cStatusB,"{\"strength\":");
...
void mCsStatus() {
	...
	bStateC = notifyDataC[11];
        ...
        bAwarmC = notifyDataC[14];                   //strength of coffee
	bCHourC = notifyDataC[8];                      //curr time
	bCMinC = notifyDataC[9];
	strcpy(cStatusC,"{\"state\":");
	itoa(notifyDataC[11],tmpvar,10);
	strcat(cStatusC,tmpvar);
	strcpy(cStatusC,"{\"strength\":");
...
void MqAState() {
	...
	strcat(ldata,"/");
	strcat(ldata,tBLEAddrA);
	strcat(ldata,"/rsp/nightlight_rgb");
	esp_mqtt_client_publish(mqttclient, ldata, tmpvar, 0, 1, 1);
//	PRgbRA = RgbRA;
//	PRgbGA = RgbGA;
//	PRgbBA = RgbBA;
...
static esp_err_t psetting_get_handler(httpd_req_t *req)
{
	...
	strcat(bsend,"\"size=\"15\">Password&emsp;<input type=\"checkbox\" name=\"chk1\" value=\"1\"");
	if (FDHass) strcat(bsend,"checked");
	strcat(bsend,"> Hass Discovery</br>");
...
//r4s state nonitoring and command execution loop
	...
	case 1:             //off
	r4slpresa = 1;
	if ((DEV_TYPA < 10) && bHtempA) mA171sHeat(0);
        if ((DEV_TYPA < 10) && bStNlA) mA171s_NLOff();
...
// every 4s get kettle state
	...
	r4slpresa = 0;
	t_SyncA++;
	if ((t_SyncA > 15) && (DEV_TYPA > 9) && (DEV_TYPA < 16)) mkSyncA();	
#ifdef USE_TFT
...
// every 1s display time and date
	...
	case 1:             //off
	r4slpresb = 1;
	if ((DEV_TYPB < 10) && bHtempB) mB171sHeat(0);
        if ((DEV_TYPB < 10) && bStNlB) mB171s_NLOff();
...
// every 4s get kettle state
	...
	r4slpresb = 0;
	t_SyncB++;
	if ((t_SyncB > 15) && (DEV_TYPB > 9) && (DEV_TYPB < 16)) mkSyncB();	
#ifdef USE_TFT
	if (tft_conn) tfblestate();
#endif
...
// every 1s display time and date
	...
	case 1:             //off
	r4slpresc = 1;
	if ((DEV_TYPC < 10) && bHtempC) mC171sHeat(0);
        if ((DEV_TYPC < 10) && bStNlC) mC171s_NLOff();
...
// every 4s get kettle state
	...
	r4slpresc = 0;
	t_SyncC++;
	if ((t_SyncC > 15) && (DEV_TYPC > 9) && (DEV_TYPC < 16)) mkSyncC();	
#ifdef USE_TFT
	if (tft_conn) tfblestate();
#endif
