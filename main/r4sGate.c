...
void mAsStatus() {
	...
	(DEV_TYPA > 3)? itoa(notifyDataA[7],tmpvar,10) : itoa(notifyDataA[8],tmpvar,10);
	strcat(cStatusA,tmpvar);
...
void mBsStatus() {
	...
	(DEV_TYPB > 3)? itoa(notifyDataB[7],tmpvar,10) : itoa(notifyDataB[8],tmpvar,10);
	strcat(cStatusB,tmpvar);
...
void mCsStatus() {
	...
	(DEV_TYPC > 3)? itoa(notifyDataC[7],tmpvar,10) : itoa(notifyDataC[8],tmpvar,10);
	strcat(cStatusC,tmpvar);
...
#endif
	strcat(bsend,"<input type=\"checkbox\" name=\"chk7\" value=\"7\"");
