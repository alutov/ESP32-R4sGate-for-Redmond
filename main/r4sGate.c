...
/*
//Initialize hw timer
//ESP_LOGI(AP_TAG, "Initialize hw_timer for callback");
	hw_timer_init(hw_timer_callback, NULL);
//ESP_LOGI(AP_TAG, "Set hw_timer timing time 50ms with reload");
	hw_timer_alarm_us(50000, true);
//
*/
