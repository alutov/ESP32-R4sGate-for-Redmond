...
static esp_err_t psetting_get_handler(httpd_req_t *req)
{
	...
	strcat(bsend,"value=\"64\">MiKettle(Int)</option><option ");
	if (DEV_TYPA == 65) strcat(bsend,"selected ");
	strcat(bsend,"value=\"65\">MiKettle(HK)</option></select>Type &emsp;NightLight");
