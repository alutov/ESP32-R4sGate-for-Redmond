...
//	} else FND_NAME[0] = 0;
            ...
            if ((adv_name != NULL) && (btopena || !btconnecta) && (btopenb || !btconnectb) && (btopenc || !btconnectc)) {
                ...
                if (((REQ_NAMEA[0]) &&  strlen(REQ_NAMEA) == adv_name_len && !strncmp((char *)adv_name, REQ_NAMEA, adv_name_len)) ||
                ((REQ_NAMEA[0]) &&  strlen(REQ_NAMEA) == 12 && !incascmp(REQ_NAMEA,FND_ADDR,12))) {
//                if ((REQ_NAMEA[0]) &&  strlen(REQ_NAMEA) == adv_name_len && !strncmp((char *)adv_name, REQ_NAMEA, adv_name_len)) {
			if (FND_NAME[0]) strcpy (RQC_NAMEA,FND_NAME);
			else strcpy (RQC_NAMEA,REQ_NAMEA);
			...
			btopena = false;
                ...
                else if (((REQ_NAMEB[0]) &&  strlen(REQ_NAMEB) == adv_name_len && !strncmp((char *)adv_name, REQ_NAMEB, adv_name_len)) ||
                ((REQ_NAMEB[0]) &&  strlen(REQ_NAMEB) == 12 && !incascmp(REQ_NAMEB,FND_ADDR,12))) {
//                else if ((REQ_NAMEB[0]) &&  strlen(REQ_NAMEB) == adv_name_len && !strncmp((char *)adv_name, REQ_NAMEB, adv_name_len)) {
			if (FND_NAME[0]) strcpy (RQC_NAMEB,FND_NAME);
			else strcpy (RQC_NAMEB,REQ_NAMEB);
			...
			btopenb = false;
                ...
                else if (((REQ_NAMEC[0]) &&  strlen(REQ_NAMEC) == adv_name_len && !strncmp((char *)adv_name, REQ_NAMEC, adv_name_len)) ||
                ((REQ_NAMEC[0]) &&  strlen(REQ_NAMEC) == 12 && !incascmp(REQ_NAMEC,FND_ADDR,12))) {
//                else if ( (REQ_NAMEC[0]) &&  strlen(REQ_NAMEC) == adv_name_len && !strncmp((char *)adv_name, REQ_NAMEC, adv_name_len)) {
			if (FND_NAME[0]) strcpy (RQC_NAMEC,FND_NAME);
			else strcpy (RQC_NAMEC,REQ_NAMEC);
...
// for RMC-961s
	if (!incascmp("off",event->data,event->data_len)) r4slppar1a = 255; 
	else if (!incascmp("Groats",event->data,event->data_len)) r4slppar1a = 0; 
	else if (!incascmp("Frying",event->data,event->data_len)) r4slppar1a = 1; 
	else if (!incascmp("Steam",event->data,event->data_len)) r4slppar1a = 2; 
	else if (!incascmp("Baking",event->data,event->data_len)) r4slppar1a = 3; 
	else if (!incascmp("Stewing",event->data,event->data_len)) r4slppar1a = 4; 
	else if (!incascmp("Multicooker",event->data,event->data_len)) r4slppar1a = 5; 
	else if (!incascmp("Pilaf",event->data,event->data_len)) r4slppar1a = 6; 
	else if (!incascmp("Soup",event->data,event->data_len)) r4slppar1a = 7; 
	else if (!incascmp("Milk_porridge",event->data,event->data_len)) r4slppar1a = 8; 
	else if (!incascmp("Yogurt",event->data,event->data_len)) r4slppar1a = 9; 
	} else if ( DEV_TYPA == 24 ) {
...
// for RMC-961s
	if (!incascmp("off",event->data,event->data_len)) r4slppar1b = 255; 
	else if (!incascmp("Groats",event->data,event->data_len)) r4slppar1b = 0; 
	else if (!incascmp("Frying",event->data,event->data_len)) r4slppar1b = 1; 
	else if (!incascmp("Steam",event->data,event->data_len)) r4slppar1b = 2; 
	else if (!incascmp("Baking",event->data,event->data_len)) r4slppar1b = 3; 
	else if (!incascmp("Stewing",event->data,event->data_len)) r4slppar1b = 4; 
	else if (!incascmp("Multicooker",event->data,event->data_len)) r4slppar1b = 5; 
	else if (!incascmp("Pilaf",event->data,event->data_len)) r4slppar1b = 6; 
	else if (!incascmp("Soup",event->data,event->data_len)) r4slppar1b = 7; 
	else if (!incascmp("Milk_porridge",event->data,event->data_len)) r4slppar1b = 8; 
	else if (!incascmp("Yogurt",event->data,event->data_len)) r4slppar1b = 9; 
	} else if ( DEV_TYPB == 24 ) {
...
// for RMC-961s
	if (!incascmp("off",event->data,event->data_len)) r4slppar1c = 255; 
	else if (!incascmp("Groats",event->data,event->data_len)) r4slppar1c = 0; 
	else if (!incascmp("Frying",event->data,event->data_len)) r4slppar1c = 1; 
	else if (!incascmp("Steam",event->data,event->data_len)) r4slppar1c = 2; 
	else if (!incascmp("Baking",event->data,event->data_len)) r4slppar1c = 3; 
	else if (!incascmp("Stewing",event->data,event->data_len)) r4slppar1c = 4; 
	else if (!incascmp("Multicooker",event->data,event->data_len)) r4slppar1c = 5; 
	else if (!incascmp("Pilaf",event->data,event->data_len)) r4slppar1c = 6; 
	else if (!incascmp("Soup",event->data,event->data_len)) r4slppar1c = 7; 
	else if (!incascmp("Milk_porridge",event->data,event->data_len)) r4slppar1c = 8; 
	else if (!incascmp("Yogurt",event->data,event->data_len)) r4slppar1c = 9; 
	} else if ( DEV_TYPC == 24 ) {
...
static esp_err_t pmain_get_handler(httpd_req_t *req)
{
	...
	(RQC_NAMEA[0])? strcat(bsend,RQC_NAMEA) : strcat(bsend,"Not defined");
	strcat(bsend,"</span></a><a class='menu' href='cfgdev2'>&#128246;<span class='showmenulabel'> 2 ");
	(RQC_NAMEB[0])? strcat(bsend,RQC_NAMEB) : strcat(bsend,"Not defined");
	strcat(bsend,"</span></a><a class='menu' href='cfgdev3'>&#128246;<span class='showmenulabel'> 3 ");
	(RQC_NAMEC[0])? strcat(bsend,RQC_NAMEC) : strcat(bsend,"Not defined");
...
static esp_err_t psetting_get_handler(httpd_req_t *req)
{
	...
	strcat(bsend,"\" size=\"15\">Name/Address &emsp;<select name=\"sreqtpa\"><option ");
	...
	if (DEV_TYPA == 19) strcat(bsend,"selected ");
...
//	strcat(bsend,"value=\"66\">V-SK152(Int)</option></select>Type &emsp;NightLight");
	...
	strcat(bsend,"\" size=\"15\">Name/Address &emsp;<select name=\"sreqtpb\"><option ");
	...
	strcat(bsend,"value=\"18\">RMC-M224S</option><option ");
	if (DEV_TYPB == 19) strcat(bsend,"selected ");
	strcat(bsend,"value=\"19\">RMC-M961S</option><option ");
...
//	strcat(bsend,"value=\"66\">V-SK152(Int)</option></select>Type &emsp;NightLight");
	...
	strcat(bsend,"\" size=\"15\">Name/Address &emsp;<select name=\"sreqtpc\"><option ");
	...
	strcat(bsend,"value=\"18\">RMC-M224S</option><option ");
	if (DEV_TYPC == 19) strcat(bsend,"selected ");
	strcat(bsend,"value=\"19\">RMC-M961S</option><option ");
...
// Close nvs
	...
	strcpy(RQC_NAMEA, REQ_NAMEA);
	strcpy(RQC_NAMEB, REQ_NAMEB);
	strcpy(RQC_NAMEC, REQ_NAMEC);
