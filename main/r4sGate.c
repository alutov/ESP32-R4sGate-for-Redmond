...
//	strcat(bsend,"value=\"66\">V-SK152(Int)</option></select>Type &emsp;NightLight");
...
#endif
        strcat(bsend,"<input name=\"ppin1\" type=\"number\" value=\"");
	itoa((bgpio1 & 0x3f),buff,10);
	strcat(bsend,buff);
	strcat(bsend,"\" min=\"0\" max=\"39\" size=\"2\">GPIO1<select name=\"popt1\"><option ");
	...
	strcat(bsend,buff);
	strcat(bsend,"\" min=\"0\" max=\"39\" size=\"2\">GPIO2<select name=\"popt2\"><option ");
	...
	strcat(bsend,buff);
	strcat(bsend,"\" min=\"0\" max=\"39\" size=\"2\">GPIO3<select name=\"popt3\"><option ");
	...
	strcat(bsend,buff);
	strcat(bsend,"\" min=\"0\" max=\"39\" size=\"2\">GPIO4<select name=\"popt4\"><option ");
	...
	strcat(bsend,buff);
	strcat(bsend,"\" min=\"0\" max=\"39\" size=\"2\">GPIO5<select name=\"popt5\"><option ");
