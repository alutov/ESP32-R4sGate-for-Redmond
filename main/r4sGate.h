...
char RQC_NAMEA[16];                          // requested1 device name
char RQC_NAMEB[16];                          // requested1 device name
char RQC_NAMEC[16];                          // requested1 device name
...
uint8_t r4slppar7a = 0;
uint8_t r4slppar8a = 0;
...
uint8_t r4slppar7b = 0;
uint8_t r4slppar8b = 0;
...
uint8_t r4slppar7c = 0;
uint8_t r4slppar8c = 0;
uint8_t r4slpresa = 0;
uint8_t r4slpresb = 0;
uint8_t r4slpresc = 0;
...
uint32_t bSEnergyA = 0;
uint32_t bSEnergyB = 0;
uint32_t bSEnergyC = 0;
uint32_t bSTimeA = 0;
uint32_t bSTimeB = 0;
uint32_t bSTimeC = 0;
uint32_t bSCountA = 0;
...
uint32_t bprevSEnergyA = 0;
uint32_t bprevSEnergyB = 0;
uint32_t bprevSEnergyC = 0;
uint32_t bprevSTimeA = 0;
uint32_t bprevSTimeB = 0;
uint32_t bprevSTimeC = 0;
uint32_t bprevSCountA = 0;
uint32_t bprevSCountB = 0;
uint32_t bprevSCountC = 0;

uint8_t bprevLockA = 0;
uint8_t bprevLockB = 0;
uint8_t bprevLockC = 0;

uint8_t bprevProgA = 0;
uint8_t bprevProgB = 0;
uint8_t bprevProgC = 0;

uint8_t bprevHeatA = 0;
uint8_t bprevHeatB = 0;
uint8_t bprevHeatC = 0;
...
uint8_t bprevStBlA = 0;
uint8_t bprevStBlB = 0;
uint8_t bprevStBlC = 0;

uint8_t bprevStBpA = 0;
uint8_t bprevStBpB = 0;
uint8_t bprevStBpC = 0;
