...
// Comment out for Â£ sign for character 24
#define TFT_ESPI_FONT2_DOLLAR

// The grave ( ` ) diacritical mark will show as a degree ( Â° ) symbol
...
const unsigned char widtbl_f16[224] =         // character width table
{
        6, 3, 4, 9, 8, 9, 9, 5,             // char 32 - 39
...
//rus
        8, 8, 8, 8, 8, 8, 10, 8,            // char 80 - 87 ÀÁÂÃ ÄÅÆÇ
        8, 8, 8, 8, 10, 8, 8, 8,            // char 88 - 8f ÈÉÊË ÌÍÎÏ
        8, 8, 8, 8, 10, 8, 8, 8,            // char 90 - 97 ÐÑÒÓ ÔÕÖ×
        8, 8, 8, 10, 8, 8, 10, 8,           // char 98 - 9f ØÙÚÛ ÜÝÞß
        7, 7, 7, 7, 8, 7, 8, 7,             // char a0 - a7 àáâã äåæç
        7, 7, 6, 7, 8, 7, 7, 7,             // char a8 - af èéêë ìíîï
        7, 7, 6, 7, 8, 6, 7, 6,             // char b0 - b7 ðñòó ôõö÷
        8, 9, 7, 8, 6, 6, 8, 7,             // char b8 - bf øùúû üýþÿ
//
...
//        0x00, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
// ' to temp
        0x00, 0x00, 0x00, 0x60, 0x90, 0x90, 0x60, 0x00, 0x00, 0x00, 0x00,    // row 1 - 11
        0x00, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
};
...
//rus
const unsigned char chr_f16_81[16] =         // 1 unsigned char per row Á
{
        0x00, 0x00, 0x00, 0xFc, 0x80, 0x80, 0x80, 0xF8, 0x84, 0x82, 0x82,    // row 1 - 11
        0x84, 0xF8, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_83[16] =         // 1 unsigned char per row Ã
{
        0x00, 0x00, 0x00, 0xFc, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,    // row 1 - 11
        0x80, 0x80, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_84[16] =         // 1 unsigned char per row Ä
{
        0x00, 0x00, 0x00, 0x1c, 0x24, 0x24, 0x24, 0x24, 0x44, 0x44, 0x44,    // row 1 - 11
        0x44, 0xfe, 0x82, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_86[32] =         // 2 unsigned chars per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x49, 0x00, 0x49, 0x00, 0x2a, 0x00,    // row 1 - 6
        0x1c, 0x00, 0x2a, 0x00, 0x49, 0x00, 0x49, 0x00, 0x88, 0x80, 0x88, 0x80,    // row 7 - 12
        0x88, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00                             // row 13 - 16
};
const unsigned char chr_f16_88[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x86, 0x86, 0x8a, 0x8a, 0x92, 0x92, 0xa2, 0xa2,    // row 1 - 11 È
        0xc2, 0xc2, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_89[16] =         // 1 unsigned char per row
{
        0x00, 0x48, 0x10, 0x86, 0x86, 0x8a, 0x8a, 0x92, 0x92, 0xa2, 0xa2,    // row 1 - 11  É
        0xc2, 0xc2, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_8B[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x0e, 0x12, 0x12, 0x12, 0x12, 0x12, 0x22, 0x22,    // row 1 - 11   Ë
        0x42, 0x82, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_8D[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x82, 0x82, 0x82, 0x82, 0xfe, 0x82, 0x82, 0x82,    // row 1 - 11   Ë
        0x82, 0x82, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_8F[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0xfe, 0x82, 0x82, 0x82, 0x82, 0x82, 0x82, 0x82,    // row 1 - 11   Ë
        0x82, 0x82, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_93[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x82, 0x82, 0x82, 0x82, 0x82, 0x7e, 0x02, 0x02,    // row 1 - 11
        0x04, 0x78, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_94[32] =         // 2 unsigned chars per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x7f, 0x80, 0x88, 0x80,    // row 1 - 6
        0x88, 0x80, 0x88, 0x80, 0x88, 0x80, 0x7f, 0x00, 0x88, 0x00, 0x08, 0x00,    // row 7 - 12
        0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00                             // row 13 - 16
};
const unsigned char chr_f16_96[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x84, 0x84, 0x84, 0x84, 0x84, 0x84, 0x84, 0x84,    // row 1 - 11
        0x84, 0xfe, 0x02, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_97[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x82, 0x82, 0x82, 0x82, 0x82, 0x7e, 0x02, 0x02,    // row 1 - 11
        0x02, 0x02, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_98[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x92, 0x92, 0x92, 0x92, 0x92, 0x92, 0x92, 0x92,    // row 1 - 11
        0xfe, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_99[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x92, 0x92, 0x92, 0x92, 0x92, 0x92, 0x92, 0x92,    // row 1 - 11
        0xfe, 0x02, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_9A[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0xc0, 0x40, 0x40, 0x40, 0x7c, 0x42, 0x42, 0x42,    // row 1 - 11
        0x42, 0x7c, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_9B[32] =         // 2 unsigned chars per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,    // row 1 - 6
        0x80, 0x80, 0xfc, 0x80, 0x82, 0x80, 0x82, 0x80, 0x82, 0x80, 0x82, 0x80,    // row 7 - 12
        0xfc, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00                             // row 13 - 16
};
const unsigned char chr_f16_9C[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x80, 0x80, 0x80, 0x80, 0xfc, 0x82, 0x82, 0x82,    // row 1 - 11
        0x82, 0xfc, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_9D[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x7c, 0x82, 0x02, 0x02, 0x7e, 0x02, 0x02, 0x02,    // row 1 - 11
        0x82, 0x7c, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_9E[32] =         // 2 unsigned chars per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x8F, 0x00, 0x90, 0x80, 0x90, 0x80,    // row 1 - 6
        0x90, 0x80, 0xf0, 0x80, 0x90, 0x80, 0x90, 0x80, 0x90, 0x80, 0x90, 0x80,    // row 7 - 12
        0x8f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00                             // row 13 - 16
};
const unsigned char chr_f16_9F[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x7e, 0x82, 0x82, 0x82, 0x82, 0x7e, 0x12, 0x22,    // row 1 - 11
        0x42, 0x82, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_A1[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x38, 0x40, 0x80, 0xf8, 0x84,    // row 1 - 11
        0x84, 0x78, 0x00, 0x00, 0x00                                         // row 12 - 16
};

const unsigned char chr_f16_A2[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xe0, 0x90, 0x90, 0xf8, 0x84,    // row 1 - 11
        0x84, 0xf8, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_A3[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xf8, 0x80, 0x80, 0x80, 0x80,    // row 1 - 11
        0x80, 0x80, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_A4[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1c, 0x24, 0x24, 0x24, 0x24,    // row 1 - 11
        0x44, 0xfe, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_A6[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x92, 0x54, 0x38, 0x54, 0x54,    // row 1 - 11
        0x92, 0x92, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_A7[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x30, 0x48, 0x08, 0x3c, 0x04,    // row 1 - 11
        0x44, 0x38, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_A8[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x84, 0x8c, 0x94, 0xb4, 0xa4,    // row 1 - 11
        0xc4, 0x84, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_A9[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x30, 0x84, 0x8c, 0x94, 0xb4, 0xa4,    // row 1 - 11
        0xc4, 0x84, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_AA[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x88, 0x90, 0xA0, 0xC0, 0xA0,    // row 1 - 11
        0x90, 0x88, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_AB[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1c, 0x24, 0x24, 0x24, 0x24,    // row 1 - 11
        0x44, 0x84, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_AC[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x82, 0xc3, 0xa5, 0x92, 0x82,    // row 1 - 11
        0x82, 0x82, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_AD[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x84, 0x84, 0x84, 0xfc, 0x84,    // row 1 - 11
        0x84, 0x84, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_AF[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xfc, 0x84, 0x84, 0x84, 0x84,    // row 1 - 11
        0x84, 0x84, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_B2[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xf8, 0x20, 0x20, 0x20, 0x20,    // row 1 - 11
        0x20, 0x20, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_B4[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x7c, 0x92, 0x92, 0x92, 0x92,    // row 1 - 11
        0x7C, 0x20, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_B6[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x88, 0x88, 0x88, 0x88, 0x88,    // row 1 - 11
        0x88, 0xfc, 0x04, 0x00, 0x00                                         // row 12 - 16
};

const unsigned char chr_f16_B7[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x88, 0x88, 0x88, 0x78, 0x08,    // row 1 - 11
        0x08, 0x08, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_B8[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x92, 0x92, 0x92, 0x92, 0x92,    // row 1 - 11
        0x92, 0xfe, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_B9[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x92, 0x92, 0x92, 0x92, 0x92,    // row 1 - 11
        0x92, 0xff, 0x01, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_BA[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc0, 0x40, 0x78, 0x44, 0x44,    // row 1 - 11
        0x44, 0x78, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_BB[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x82, 0x82, 0xf2, 0x8a, 0x8a,    // row 1 - 11
        0x8a, 0xf2, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_BC[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x80, 0xf0, 0x88, 0x88,    // row 1 - 11
        0x88, 0xf0, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_BD[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xf0, 0x08, 0x08, 0x78, 0x08,    // row 1 - 11
        0x08, 0xf0, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_BE[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x9c, 0xa2, 0xa2, 0xe2, 0xa2,    // row 1 - 11
        0xa2, 0x9c, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_BF[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7c, 0x84, 0x84, 0x7c, 0x24,    // row 1 - 11
        0x44, 0x84, 0x00, 0x00, 0x00                                         // row 12 - 16
};
...
{
        0x00, 0x00, 0x00, 0x00, 0x07, 0x1F, 0x27, 0x66, 0x81, 0x81, 0x95,    // row 1 - 11
        0x55, 0x14, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_EE[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x24, 0x36, 0x81, 0x81, 0x89,    // row 1 - 11
        0x5C, 0x08, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_EF[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x24, 0x36, 0x81, 0x81, 0x91,    // row 1 - 11
        0x5A, 0x08, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_F0[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x92, 0x00, 0x38, 0xBA, 0x38, 0x00, 0x92,    // row 1 - 11
        0x00, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_F1[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x24, 0x36, 0x81, 0x81, 0x81,    // row 1 - 11
        0x7E, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_F2[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x07, 0x1F, 0x27, 0x66, 0x81, 0x81, 0x81,    // row 1 - 11
        0x7E, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_F3[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x24, 0x36, 0x81, 0x81, 0x95,    // row 1 - 11
        0x55, 0x14, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_F4[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x92, 0x54, 0x38, 0xFE, 0x38, 0x54,    // row 1 - 11
...
const unsigned char chr_f16_F7[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x10, 0x38, 0x54, 0x10, 0x10, 0x10, 0x10,    // row 1 - 11
        0x10, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_F8[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x04, 0xFE, 0x04, 0x08, 0x00,    // row 1 - 11
        0x00, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_F9[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x10, 0x10, 0x10, 0x10, 0x10, 0x54, 0x38,    // row 1 - 11
        0x10, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_FA[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x28, 0x44, 0xFE, 0x44, 0x28, 0x00,    // row 1 - 11
        0x00, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_FB[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x10, 0x38, 0x54, 0x10, 0x10, 0x54, 0x38,    // row 1 - 11
        0x10, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_FC[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0xF0, 0xC0, 0xA0, 0x90, 0x08, 0x04, 0x02,    // row 1 - 11
        0x00, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_FD[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x1E, 0x06, 0x0A, 0x12, 0x20, 0x40, 0x80,    // row 1 - 11
        0x00, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_FE[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x80, 0x40, 0x20, 0x12, 0x0A, 0x06, 0x1E,    // row 1 - 11
        0x00, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
};
const unsigned char chr_f16_FF[16] =         // 1 unsigned char per row
{
        0x00, 0x00, 0x00, 0x00, 0x02, 0x04, 0x08, 0x90, 0xA0, 0xC0, 0xF0,    // row 1 - 11
        0x00, 0x00, 0x00, 0x00, 0x00                                         // row 12 - 16
};
...
//rus
        chr_f16_41, chr_f16_81, chr_f16_42, chr_f16_83, chr_f16_84, chr_f16_45, chr_f16_86, chr_f16_33, //ÀÁÂÃ ÄÅÆÇ
        chr_f16_88, chr_f16_89, chr_f16_4B, chr_f16_8B, chr_f16_4D, chr_f16_8D, chr_f16_4F, chr_f16_8F, //ÈÉÊË ÌÍÎÏ
        chr_f16_50, chr_f16_43, chr_f16_54, chr_f16_93, chr_f16_94, chr_f16_58, chr_f16_96, chr_f16_97, //ÐÑÒÓ ÔÕÖ×
        chr_f16_98, chr_f16_99, chr_f16_9A, chr_f16_9B, chr_f16_9C, chr_f16_9D, chr_f16_9E, chr_f16_9F, //ØÙÚÛ ÜÝÞß
//                                                                                                                 
        chr_f16_61, chr_f16_A1, chr_f16_A2, chr_f16_A3, chr_f16_A4, chr_f16_65, chr_f16_A6, chr_f16_A7, //àáâã äåæç
        chr_f16_A8, chr_f16_A9, chr_f16_AA, chr_f16_AB, chr_f16_AC, chr_f16_AD, chr_f16_6F, chr_f16_AF, //èéêë ìíîï
        chr_f16_70, chr_f16_63, chr_f16_B2, chr_f16_79, chr_f16_B4, chr_f16_78, chr_f16_B6, chr_f16_B7, //ðñòó ôõö÷
        chr_f16_B8, chr_f16_B9, chr_f16_BA, chr_f16_BB, chr_f16_BC, chr_f16_BD, chr_f16_BE, chr_f16_BF, //øùúû üýþÿ
//
