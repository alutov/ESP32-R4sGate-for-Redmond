...
void tfblestate()
{
	...
	if (BleDevStA.REQ_NAME[0] && (blstnum == 0)) {
	sumx = drawString("Mqtt, ", 0, 224, 2);
	if (BleDevStA.btauthoriz) {
	if (!BleDevStA.bState && BleDevStA.bHeat) setTextColor(TFT_YELLOW, TFT_BLACK);
	else if (!BleDevStA.bState) setTextColor(TFT_BLUE, TFT_BLACK);
	else if (BleDevStA.bState == 254) setTextColor(TFT_DARKGREY, TFT_BLACK);
	else if ((BleDevStA.DEV_TYP > 15) && (BleDevStA.DEV_TYP < 24) && (BleDevStA.bState == 1)) setTextColor(TFT_WHITE, TFT_BLACK);
	else if ((BleDevStA.DEV_TYP > 15) && (BleDevStA.DEV_TYP < 20) && (BleDevStA.bState == 5)) setTextColor(TFT_YELLOW, TFT_BLACK);
	else if ((BleDevStA.DEV_TYP > 19) && (BleDevStA.DEV_TYP < 24) && (BleDevStA.bState == 2)) setTextColor(TFT_YELLOW, TFT_BLACK);
	else setTextColor(TFT_RED, TFT_BLACK);
	sumx += drawString(BleDevStA.DEV_NAME, sumx, 224, 2);
	sumx += drawString(":", sumx, 224, 2);
        setTextColor(TFT_GREEN, TFT_BLACK);
	if (!BleDevStA.DEV_TYP) {
	sumx += drawString(" Not Defined, ", sumx, 224, 2);
	} else if ((BleDevStA.DEV_TYP < 10) || (BleDevStA.DEV_TYP > 63)) {
	sumx += drawString(" Temp: ", sumx, 224, 2);
	if (BleDevStA.bCtemp > 79) setTextColor(TFT_WHITE, TFT_BLACK);
	else if (BleDevStA.bCtemp > 39) setTextColor(TFT_YELLOW, TFT_BLACK);
	else if (BleDevStA.bCtemp == 0) setTextColor(TFT_DARKGREY, TFT_BLACK);
	itoa(BleDevStA.bCtemp,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("'", sumx, 224, 2);
        setTextColor(TFT_GREEN, TFT_BLACK);
	sumx += drawString(", Heat: ", sumx, 224, 2);
	if (BleDevStA.bHtemp > 79) setTextColor(TFT_WHITE, TFT_BLACK);
	else if (BleDevStA.bHtemp > 39) setTextColor(TFT_YELLOW, TFT_BLACK);
	itoa(BleDevStA.bHtemp,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("'", sumx, 224, 2);
	} else if (BleDevStA.DEV_TYP < 12) {
	...
	} else if (BleDevStA.DEV_TYP < 64) {
	sumx += drawString(" P: ", sumx, 224, 2);
	itoa(BleDevStA.bProg,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("/", sumx, 224, 2);
	itoa(BleDevStA.bModProg,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("/", sumx, 224, 2);
	itoa(BleDevStA.bHtemp,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("', T: ", sumx, 224, 2);
	itoa(BleDevStA.bCHour,buff,10);
	if (BleDevStA.bCHour <10) sumx += drawString("0", sumx, 224, 2);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString(":", sumx, 224, 2);
	itoa(BleDevStA.bCMin,buff,10);
	if (BleDevStA.bCMin <10) sumx += drawString("0", sumx, 224, 2);
	sumx += drawString(buff, sumx, 224, 2);
	}
        setTextColor(TFT_GREEN, TFT_BLACK);
	sumx += drawString(", ", sumx, 224, 2);
	if (BleDevStA.iRssi < -100) setTextColor(TFT_WHITE, TFT_BLACK);
	else if (BleDevStA.iRssi < -90) setTextColor(TFT_YELLOW, TFT_BLACK);
	...
	if (BleDevStA.DEV_NAME[0]) strcpy(buf,BleDevStA.DEV_NAME);
	...
	if (BleDevStB.REQ_NAME[0] && (blstnum == 1)) {
	sumx = drawString("Mqtt, ", 0, 224, 2);
	if (BleDevStB.btauthoriz) {
	if (!BleDevStB.bState && BleDevStB.bHeat) setTextColor(TFT_YELLOW, TFT_BLACK);
	else if (!BleDevStB.bState) setTextColor(TFT_BLUE, TFT_BLACK);
	else if (BleDevStB.bState == 254) setTextColor(TFT_DARKGREY, TFT_BLACK);
	else if ((BleDevStB.DEV_TYP > 15) && (BleDevStB.DEV_TYP < 24) && (BleDevStB.bState == 1)) setTextColor(TFT_WHITE, TFT_BLACK);
	else if ((BleDevStB.DEV_TYP > 15) && (BleDevStB.DEV_TYP < 20) && (BleDevStB.bState == 5)) setTextColor(TFT_YELLOW, TFT_BLACK);
	else if ((BleDevStB.DEV_TYP > 19) && (BleDevStB.DEV_TYP < 24) && (BleDevStB.bState == 2)) setTextColor(TFT_YELLOW, TFT_BLACK);
	else setTextColor(TFT_RED, TFT_BLACK);
	sumx += drawString(BleDevStB.DEV_NAME, sumx, 224, 2);
	sumx += drawString(":", sumx, 224, 2);
        setTextColor(TFT_GREEN, TFT_BLACK);
	if (!BleDevStB.DEV_TYP) {
	sumx += drawString(" Not Defined, ", sumx, 224, 2);
	} else if ((BleDevStB.DEV_TYP < 10) || (BleDevStB.DEV_TYP > 63)) {
	sumx += drawString(" Temp: ", sumx, 224, 2);
	if (BleDevStB.bCtemp > 79) setTextColor(TFT_WHITE, TFT_BLACK);
	else if (BleDevStB.bCtemp > 39) setTextColor(TFT_YELLOW, TFT_BLACK);
	else if (BleDevStB.bCtemp == 0) setTextColor(TFT_DARKGREY, TFT_BLACK);
	itoa(BleDevStB.bCtemp,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("'", sumx, 224, 2);
        setTextColor(TFT_GREEN, TFT_BLACK);
	sumx += drawString(", Heat: ", sumx, 224, 2);
	if (BleDevStB.bHtemp > 79) setTextColor(TFT_WHITE, TFT_BLACK);
	else if (BleDevStB.bHtemp > 39) setTextColor(TFT_YELLOW, TFT_BLACK);
	itoa(BleDevStB.bHtemp,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("'", sumx, 224, 2);
	} else if (BleDevStB.DEV_TYP < 12) {
	sumx += drawString(" Lock: ", sumx, 224, 2);
	if (BleDevStB.bLock) {
        setTextColor(TFT_RED, TFT_BLACK);
	sumx += drawString("On", sumx, 224, 2);
	} else sumx += drawString("Off", sumx, 224, 2);
	} else if (BleDevStB.DEV_TYP < 16) {
	sumx += drawString(" Lock: ", sumx, 224, 2);
	if (BleDevStB.bLock) {
        setTextColor(TFT_RED, TFT_BLACK);
	sumx += drawString("On", sumx, 224, 2);
	...
	} else if (BleDevStB.DEV_TYP < 64) {
	sumx += drawString(" P: ", sumx, 224, 2);
	itoa(BleDevStB.bProg,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("/", sumx, 224, 2);
	itoa(BleDevStB.bModProg,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("/", sumx, 224, 2);
	itoa(BleDevStB.bHtemp,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("', T: ", sumx, 224, 2);
	itoa(BleDevStB.bCHour,buff,10);
	if (BleDevStB.bCHour <10) sumx += drawString("0", sumx, 224, 2);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString(":", sumx, 224, 2);
	itoa(BleDevStB.bCMin,buff,10);
	if (BleDevStB.bCMin <10) sumx += drawString("0", sumx, 224, 2);
	sumx += drawString(buff, sumx, 224, 2);
	}
        setTextColor(TFT_GREEN, TFT_BLACK);
	sumx += drawString(", ", sumx, 224, 2);
	if (BleDevStB.iRssi < -100) setTextColor(TFT_WHITE, TFT_BLACK);
	else if (BleDevStB.iRssi < -90) setTextColor(TFT_YELLOW, TFT_BLACK);
	...
	setTextColor(TFT_DARKGREY, TFT_BLACK);
	if (BleDevStB.DEV_NAME[0]) strcpy(buf,BleDevStB.DEV_NAME);
	...
	if (BleDevStC.REQ_NAME[0] && (blstnum == 2)) {
	sumx = drawString("Mqtt, ", 0, 224, 2);
	if (BleDevStC.btauthoriz) {
	if (!BleDevStC.bState && BleDevStC.bHeat) setTextColor(TFT_YELLOW, TFT_BLACK);
	else if (!BleDevStC.bState) setTextColor(TFT_BLUE, TFT_BLACK);
	else if (BleDevStC.bState == 254) setTextColor(TFT_DARKGREY, TFT_BLACK);
	else if ((BleDevStC.DEV_TYP > 15) && (BleDevStC.DEV_TYP < 24) && (BleDevStC.bState == 1)) setTextColor(TFT_WHITE, TFT_BLACK);
	else if ((BleDevStC.DEV_TYP > 15) && (BleDevStC.DEV_TYP < 20) && (BleDevStC.bState == 5)) setTextColor(TFT_YELLOW, TFT_BLACK);
	else if ((BleDevStC.DEV_TYP > 19) && (BleDevStC.DEV_TYP < 24) && (BleDevStC.bState == 2)) setTextColor(TFT_YELLOW, TFT_BLACK);
	else setTextColor(TFT_RED, TFT_BLACK);
	sumx += drawString(BleDevStC.DEV_NAME, sumx, 224, 2);
	sumx += drawString(":", sumx, 224, 2);
        setTextColor(TFT_GREEN, TFT_BLACK);
	if (!BleDevStC.DEV_TYP) {
	sumx += drawString(" Not Defined, ", sumx, 224, 2);
	} else if ((BleDevStC.DEV_TYP < 10) || (BleDevStC.DEV_TYP > 63)) {
	sumx += drawString(" Temp: ", sumx, 224, 2);
	if (BleDevStC.bCtemp > 79) setTextColor(TFT_WHITE, TFT_BLACK);
	else if (BleDevStC.bCtemp > 39) setTextColor(TFT_YELLOW, TFT_BLACK);
	else if (BleDevStC.bCtemp == 0) setTextColor(TFT_DARKGREY, TFT_BLACK);
	itoa(BleDevStC.bCtemp,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("'", sumx, 224, 2);
        setTextColor(TFT_GREEN, TFT_BLACK);
	sumx += drawString(", Heat: ", sumx, 224, 2);
	if (BleDevStC.bHtemp > 79) setTextColor(TFT_WHITE, TFT_BLACK);
	else if (BleDevStC.bHtemp > 39) setTextColor(TFT_YELLOW, TFT_BLACK);
	itoa(BleDevStC.bHtemp,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("'", sumx, 224, 2);
	} else if (BleDevStC.DEV_TYP < 12) {
	sumx += drawString(" Lock: ", sumx, 224, 2);
	if (BleDevStC.bLock) {
        setTextColor(TFT_RED, TFT_BLACK);
	sumx += drawString("On", sumx, 224, 2);
	} else sumx += drawString("Off", sumx, 224, 2);
	} else if (BleDevStC.DEV_TYP < 16) {
	sumx += drawString(" Lock: ", sumx, 224, 2);
	if (BleDevStC.bLock) {
        setTextColor(TFT_RED, TFT_BLACK);
	sumx += drawString("On", sumx, 224, 2);
	...
	} else if (BleDevStC.DEV_TYP < 64) {
	sumx += drawString(" P: ", sumx, 224, 2);
	itoa(BleDevStC.bProg,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("/", sumx, 224, 2);
	itoa(BleDevStC.bModProg,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("/", sumx, 224, 2);
	itoa(BleDevStC.bHtemp,buff,10);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString("', T: ", sumx, 224, 2);
	itoa(BleDevStC.bCHour,buff,10);
	if (BleDevStC.bCHour <10) sumx += drawString("0", sumx, 224, 2);
	sumx += drawString(buff, sumx, 224, 2);
	sumx += drawString(":", sumx, 224, 2);
	itoa(BleDevStC.bCMin,buff,10);
	if (BleDevStC.bCMin <10) sumx += drawString("0", sumx, 224, 2);
	sumx += drawString(buff, sumx, 224, 2);
	}
        setTextColor(TFT_GREEN, TFT_BLACK);
	sumx += drawString(", ", sumx, 224, 2);
	if (BleDevStC.iRssi < -100) setTextColor(TFT_WHITE, TFT_BLACK);
	else if (BleDevStC.iRssi < -90) setTextColor(TFT_YELLOW, TFT_BLACK);
	...
	setTextColor(TFT_DARKGREY, TFT_BLACK);
	if (BleDevStC.DEV_NAME[0]) strcpy(buf,BleDevStC.DEV_NAME);
