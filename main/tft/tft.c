...
DRAM_ATTR static const lcd_init_cmd_t ili_init1_cmds[]={
    {0x36, {0x28}, 1},
};
...
///Disable backlight
	...
	if (tft_flip) {
	CS_L;
	lcd_cmd(spi, ili_init1_cmds[0].cmd);
	lcd_data(spi, ili_init1_cmds[0].data, ili_init1_cmds[0].databytes&0x1F);
	CS_H;
	}
