...
void tftclock()
{
	...
	sumx = 278;
	if (!btauthoriza) setTextColor(TFT_DARKGREY, TFT_BLACK);
	else if (!bStateA && bHeatA) setTextColor(TFT_YELLOW, TFT_BLACK);
	...
	if (!btauthorizb) setTextColor(TFT_DARKGREY, TFT_BLACK);
	else if (!bStateB && bHeatB) setTextColor(TFT_YELLOW, TFT_BLACK);
	...
	if (!btauthorizc) setTextColor(TFT_DARKGREY, TFT_BLACK);
	else if (!bStateC && bHeatC) setTextColor(TFT_YELLOW, TFT_BLACK);
